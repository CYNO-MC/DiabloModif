...
import com.cyno.diablo.blocks.NetherBrickPlankBlock;
...
public class DiabloBlocks {
    ...
    public static final RegistryObject<Block> NETHER_BRICK_PLANK_BLOCK = BLOCKS.register("nether_brick_plank_block", NetherBrickPlankBlock:: new);
